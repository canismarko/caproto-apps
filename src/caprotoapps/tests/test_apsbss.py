...
esaf = {
    'description': ('Electrochemical battery cells will be assembled in an '
...
async def test_update_proposal(mock_ioc):
    ...
    ioc.bss._api._prop_api.getProposal.assert_called_with("74204", cycle="2022-2", beamline="20-BM-B")
    # Check that the metadata was updated
    ...
    assert ioc.bss.proposal.user1.institution.value == "University of Colorado at Boulder"
